...
# Gives the music room to resolve its final phrase naturally instead of hard-stopping.
# The LLM still composes to the base target; only the ACE-Step generation window grows.
DURATION_OVERRUN_S = 30
